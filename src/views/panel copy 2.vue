  ...
  <div style="display: flex; margin: 0; padding: 0">
    <div style="display: block">
      ...
      <div style="width: 270px;">
        ...
        <v-btn @click="renderForceSvg">更新数据集</v-btn>
        <v-btn @click="renderHistoricalDataset" v-if="nodesStorage['nodes']">历史数据集</v-btn>
      </div>
    ...
    <div class="container" style="width: 1100px; height: 450px">
      ...
      <svg ref="scatterPlot0" style="width:100%;height:1000px"></svg>
...
export default {
  ...
  methods: {
    ...
    renderForceSvg() {
      ...
      let node = this.forceSvg.append("g")
        .selectAll('circle')
        .data(nodes)
        .enter().append("circle")
        .attr("transform", d => `translate(0,0)`)
    ...
    initForceSvg() {
      ...
      let svg = d3.select(this.$refs.scatterPlot0)
        .attr("viewBox", [-width, -height, width * 4, height * 4])
        .attr("width", width)
        .attr("height", height)
