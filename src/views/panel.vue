    ...
    <div style="display: flex; margin: 0; padding: 0">
        ...
        <div class="container" style="width: 0;flex: 1;">
            ...
            <div style="height: 600px; display: flex">
                <div style="width: 50%">
                    <scatter-plot ref="childComponent1" :selectActNode="selectActNode1" :dataList="dataList"
                        @click-node="(data) => clickNode(data, 1)"></scatter-plot>
                </div>
                <div style="width: 50%">
                    <scatter-plot ref="childComponent2" :selectActNode="selectActNode2" :dataList="dataList"
                        @click-node="(data) => clickNode(data, 2)"></scatter-plot>
                </div>
            </div>
        ...
        drawChart() {
            ...
            if (sf.brush === true) {
                sf.brush1 = d3
                    ...
                    .extent([
                        [0, 0],
                        [width + margin.left + width + margin.right + 100, height + 50]
                    ])
                ...
                function brushed1(event) {
                    ...
                    if (actualX0 <= 569 && actualX1 <= 569) {
                        scatter1Group.selectAll('circle').each(function (d, i) {
                            ...
                            if (cx >= actualX0 && cx <= actualX1 && cy >= actualY0 && cy <= actualY1) {
                                ...
                                collected1.push(i)
                                sf.selectActNode1.push(d.index)
                        ...
                        scatter2Group.selectAll('circle').each(function (d, i) {
                            ...
                            if (
                                ...
                                collected.push(d.index)
                                collected1.push(i)
                                sf.selectActNode2.push(d.index)
                                // console.log(x0, y0, x1, y1, cx, cy);
                                const node1X = xScale1(scatter1[i].x)
                                const node1Y = yScale1(scatter1[i].y)
                    ...
                    const xScale3 = d3.scaleBand().domain(['emb1', 'emb2']).range([0, 200]).padding(0.3)
