  ...
  <div style="display: flex; margin: 0; padding: 0">
    ...
    <div class="container" style="width: 1100px">
      ...
      <div style="height: 500px; display: flex">
        <div style="width: 50%">
          <scatter-plot ref="childComponent1" :dataList="dataList" @click-node="(data)=>clickNode(data,1)"></scatter-plot>
        </div>
        <div style="width: 50%">
          <scatter-plot ref="childComponent2"  :dataList="dataList" @click-node="(data)=>clickNode(data,2)"></scatter-plot>
        </div>
      </div>
